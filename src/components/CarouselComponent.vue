...
export default {
  ...
  setup() {
    ...
    const image1Path = ref(require('@/assets/images/carousel-1.jpg'));
    const image2Path = ref(require('@/assets/images/carousel-2.jpg'));
    const image3Path = ref(require('@/assets/images/carousel-3.jpg'));
